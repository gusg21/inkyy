...
GOTO :eof
   ...
   ::  Pad digits to -->
   :s_0
      (SET _1=%_1% %char%%char%%char%%char%)
      (SET _2=%_2% %char%  %char%)
      (SET _3=%_3% %char%  %char%)
      (SET _4=%_4% %char%  %char%)
      (SET _5=%_5% %char%  %char%)
      (SET _6=%_6% %char%  %char%)
      (SET _7=%_7% %char%%char%%char%%char%)
   GOTO :EOF
   ...
   :s_b
   ::  Pad digits to -->
      (SET _1=%_1% %char%%char%%char% )
      (SET _2=%_2% %char%  %char%)
      (SET _3=%_3% %char%  %char%)
      (SET _4=%_4% %char%%char%%char%%char%)
      (SET _5=%_5% %char%  %char%)
      (SET _6=%_6% %char%  %char%)
      (SET _7=%_7% %char%%char%%char% )
   GOTO :EOF
   ...
   ::  Pad digits to --->
      (SET _1=%_1% %char%   %char%)
      (SET _2=%_2% %char%%char% %char%%char%)
      (SET _3=%_3% %char% %char% %char%)
      (SET _4=%_4% %char% %char% %char%)
      (SET _5=%_5% %char%   %char%)
      (SET _6=%_6% %char%   %char%)
      (SET _7=%_7% %char%   %char%)
   ...
   ::  Pad digits to --->
      (SET _1=%_1% %char%   %char%)
      (SET _2=%_2% %char%%char%  %char%)
      (SET _3=%_3% %char%%char%  %char%)
      (SET _4=%_4% %char% %char% %char%)
      (SET _5=%_5% %char%  %char%%char%)
      (SET _6=%_6% %char%  %char%%char%)
      (SET _7=%_7% %char%   %char%)
   GOTO :EOF
   ...
   :s_z
   ::  Pad digits to --->
      (SET _1=%_1% %char%%char%%char%%char%%char%)
      (SET _2=%_2%     %char%)
      (SET _3=%_3%    %char% )
      (SET _4=%_4%   %char%  )
      (SET _5=%_5%  %char%   )
      (SET _6=%_6% %char%    )
      (SET _7=%_7% %char%%char%%char%%char%%char%)
   GOTO :EOF
